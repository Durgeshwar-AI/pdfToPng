...
const tools = [
  ...
  },
  {
    ...
    category: 'PDF Tools',
    icon: <ArrowDownUp />,
    description: 'Reorder PDF pages by dragging and dropping thumbnails into a new sequence.',
    path: '/pdf-reorder',
  ...
  },
  {
    ...
    icon: <Droplets />,
    description:
      'Add text or image watermarks to protect your photos with custom positioning and opacity.',
  ...
  },
  {
    ...
    category: 'Utilities',
    icon: <QrCode />,
    description: 'Generate QR codes from website URLs for quick sharing and access.',
    path: '/url-to-qr',
  ...
  },
  {
    ...
    category: 'Conversion Tools',
    icon: <FileText />,
    description: 'Convert text-based PDF documents into editable Word (.docx) files.',
    path: '/pdf-to-word',
