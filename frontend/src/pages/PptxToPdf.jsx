...
function PptxToPdf() {
  const validateFile = useCallback(selectedFile => {
    const accepted = ['application/vnd.openxmlformats-officedocument.presentationml.presentation'];
  ...
  return (
    <div className="theme-panel mx-auto flex w-full max-w-[700px] flex-col items-center justify-center overflow-hidden rounded-2xl p-10 text-center">
      ...
      <p className="-mt-6 mb-8 text-sm text-gray-500">Upload a .pptx file to convert it to PDF.</p>
